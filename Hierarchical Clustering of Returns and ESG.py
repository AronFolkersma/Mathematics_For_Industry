...
def parallel_coordinates_plot(num_clusters_list, sigma_list):
    ...
    fig.write_html("High_ESG_Constraint.html")
...
global risk_aversion; risk_aversion = 5  # Adjust risk aversion (low value is high return/high risk and high value low return/low risk)
